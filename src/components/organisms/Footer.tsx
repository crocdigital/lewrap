                ...
                <div className="col-span-2 md:col-span-1">
                    <a href="/">
                        <img
                            ...
                            alt="LeWrap"
                            className="mx-auto md:mx-0 w-[157px] h-[46px]"
                        />
                    </a>
