  ...
  try {
    ...
    const customerEmailHTML = `
      ...
      <body>
        ...
        <div class="content">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <p style="font-size: 16px; margin-bottom: 15px;"><strong>Download Your Franchise Information Pack</strong></p>
            <a href="https://lewrap.com/downloads/LW-Franchising-Pack-August-2026.pdf" class="download-button">📄 Download Info Pack</a>
            <p style="font-size: 13px; color: #666; margin-top: 10px;">This comprehensive guide contains everything you need to know about our franchise opportunity.</p>
          </div>
    ...
    const { error: supabaseError } = await supabase
      ...
      .insert({
        ...
        fund_capacity: fundCapacity,
        status: 'new',
      });

    if (supabaseError) {
      // Log the error but don't fail the request
      // Emails already sent successfully so we don't want to show an error to the user
